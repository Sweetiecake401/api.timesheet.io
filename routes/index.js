...
//reports
// router.route('/reports/fetchTimesheet').post(indexController.testreport.fetchTimeSheetByDate);
router
  .route("/reports/fetchUser")
  .post(indexController.testreport.fetchUserSheet);
router
  .route("/reports/fetchAllUser")
  .post(indexController.testreport.getAllUsers);
router
  .route("/reports/allTimesheet")
  .post(indexController.testreport.getJackofAllUsers);
//assign
...
router.route("/created/department").post(indexController.create.getDepartment);
router.route("/created/gender").post(indexController.create.getGender);
router.route("/created/group").post(indexController.create.getGroup);
router.route("/created/position").post(indexController.create.getPosition);
